...
# gist link https://gist.github.com/jm-rives/d0f6da472c76e8ba727ad80908d54344 as of 8/9/2016
...
def year_to_hours(years)
  puts "Here is the hours in the year(s)."
  $year_in_seconds * years / $hour_in_seconds
end

def decade_to_minutes(decades)
  puts "Here is the decade(s) in minutes."
  ($year_in_seconds * (decades * 10)) / 60
end

def year_old_to_seconds(age)
  puts "Here is the entered age in seconds: "
  $year_in_seconds * age
end

def seconds_to_years(seconds)
  puts "Here is the seconds in years: "
